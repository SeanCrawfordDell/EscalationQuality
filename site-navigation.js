(() => {
  ...
  const initialize = () => {
    ...
    if (nav && !nav.querySelector('[href="tools.html"]')) nav.insertAdjacentHTML('afterbegin', '<div class="menu-item"><a class="menu-trigger" href="tools.html">Tools <span aria-hidden="true">⌄</span></a><div class="submenu" role="menu"><a href="tools.html" role="menuitem">Tools hub</a><a href="https://seancrawforddell.github.io/DellSupportoolRepository/#/tools" target="_blank" rel="noopener noreferrer" role="menuitem">ISG Tools Catalog</a><a href="https://github.com/DellProSupportGse/Tools" target="_blank" rel="noopener noreferrer" role="menuitem">Microsoft Support Tools</a></div></div><div class="menu-item"><a class="menu-trigger" href="case-notes.html">Case Management <span aria-hidden="true">⌄</span></a><div class="submenu" role="menu"><a href="escalation-quality.html" role="menuitem">DE Escalation Request</a><a href="case-notes.html" role="menuitem">Case Notes</a></div></div>');
