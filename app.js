...
const fieldIds = ["problem", "impact", "timeline", "expected", "country", "asset", "os", "errors", "reproduction", "troubleshooting", "results", "evidence", "changes", "workaround", "request"];
const required = ["problem", "impact", "timeline", "expected", "country", "asset", "os", "reproduction", "troubleshooting", "results", "request"];
const labels = {
  problem: "problem statement", impact: "business impact", timeline: "timeline and frequency", expected: "expected behavior", country: "customer country", asset: "product / asset identifier", os: "operating system & version", errors: "exact errors and timestamps", reproduction: "reproduction steps", troubleshooting: "troubleshooting performed", results: "results and observations", evidence: "logs and evidence", changes: "recent changes", workaround: "current workaround", request: "requested senior assistance"
};
