...
const fieldIds = ["problem", "impact", "timeline", "expected", "country", "asset", "os", "environment", "errors", "reproduction", "troubleshooting", "results", "evidence", "changes", "workaround", "request"];
const required = ["problem", "impact", "timeline", "expected", "country", "asset", "os", "environment", "reproduction", "troubleshooting", "results", "request"];
const labels = {
  problem: "problem statement", impact: "business impact", timeline: "timeline and frequency", expected: "expected behavior", country: "customer country", asset: "product / asset identifier", os: "operating system & version", environment: "environment and versions", errors: "exact errors and timestamps", reproduction: "reproduction steps", troubleshooting: "troubleshooting performed", results: "results and observations", evidence: "logs and evidence", changes: "recent changes", workaround: "current workaround", request: "requested senior assistance"
};
...
function evaluate(form) {
  ...
  const completedRequired = required.filter(id => hasDetail(form[id], id === "asset" || id === "country" || id === "os" ? 2 : 15)).length;
  const completeness = Math.round(30 * completedRequired / required.length);
  const coreText = [form.problem, form.impact, form.timeline, form.environment, form.os].join(" ");
