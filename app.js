...
const required = ["problem", "impact", "timeline", "expected", "country", "asset", "os", "reproduction", "troubleshooting", "results", "evidence", "request"];
const labels = {
...
const samples = {
  weak: { problem:"System not working", impact:"Users affected", timeline:"Started recently", expected:"It should work", country:"US", asset:"Server", os:"Windows", errors:"Unknown", reproduction:"Try to use it", troubleshooting:"Restarted and checked things", results:"No change", evidence:"No", changes:"Unknown", workaround:"None", request:"Please help" },
